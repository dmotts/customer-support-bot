    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            <tr valign="top">
                ...
                <td>
                    <!-- Display the current avatar image preview -->
            ...
            <tr valign="top">
                ...
                <td>
                    <!-- Input field for the virtual assistant's name -->
