<div class="wrap">
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            ...
            <!-- OpenAI API Key Field (Optional, for fallback or future features) -->
            <tr valign="top">
                <th scope="row">OpenAI API Key (Optional)</th>
                <td>
                    <input type="text" name="vacw_openai_api_key" value="<?php echo esc_attr(get_option('vacw_openai_api_key')); ?>" />
                    <p class="description">Enter your OpenAI API key (if applicable) for chatbot functionality.</p>
                </td>
            </tr>
        </table>
        <?php 
